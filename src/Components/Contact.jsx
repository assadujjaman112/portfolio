      ...
      <div className="bg-slate-200 rounded-lg py-5 text-black flex flex-col pl-5 md:pl-10 lg:pl-0 lg:flex-row justify-center lg:justify-evenly mt-5">
        <h1 className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold flex gap-2 items-center">
            <MdEmail className="text-xl"></MdEmail> Email{" "}
          </span>
          <span className="font-semibold">:</span>assadujjamanmurad120@gamil.com
        </h1>
        <h1 className="flex items-center gap-2">
          {" "}
          <span className="text-lg font-bold flex gap-2 items-center">
            <MdLocalPhone className="text-xl"></MdLocalPhone> Phone :{" "}
          </span>
          +8801959691545
        </h1>
        <h1 className="flex items-center gap-2">
          {" "}
          <span className="text-lg font-bold flex gap-2 items-center">
            <MdLocationOn className="text-xl"></MdLocationOn> Address :{" "}
          </span>
          Dhanmondi, Dhaka
        </h1>
      </div>
